/* aarch64-w64-mingw32/config.h.  Generated from config.h.in by configure.  */
...
#define ERTS_EMU_CMDLINE_FLAGS " -Werror=undef -Werror=implicit -Werror=return-type  -fno-common -fstrict-flex-arrays=3 -fno-strict-aliasing -fno-delete-null-pointer-checks -fno-strict-overflow -fexceptions -mbranch-protection=standard -fstack-protector-strong -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=3 -g -O2 -I/Users/aarhodes/src/zig-erlang/sources/otp-28.1/erts/aarch64-w64-mingw32   -D_GLIBCXX_ASSERTIONS -g -O2 -std=c++17 -g -Og  -Werror=undef -Werror=implicit -Werror=return-type  -fno-common -fstrict-flex-arrays=3 -fno-strict-aliasing -fno-delete-null-pointer-checks -fno-strict-overflow -fexceptions -mbranch-protection=standard -fstack-protector-strong -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=3 -g  -I/Users/aarhodes/src/zig-erlang/sources/otp-28.1/erts/aarch64-w64-mingw32   -g -Og  -D_GLIBCXX_ASSERTIONS -g  -std=c++17  -DUSE_THREADS -D_THREAD_SAFE -D_REENTRANT -DPOSIX_THREADS  -Werror=undef -Werror=implicit -Werror=return-type  -Wall -Wstrict-prototypes -Wpointer-arith -Wmissing-prototypes -Wdeclaration-after-statement"
...
/* Use verbose mutex names */
#define ESOCK_VERBOSE_MTX_NAMES 1
...
#define ETHR_HAVE_GCC_ASM_ARM_DC_CVAU_INSTRUCTION 1
...
#define ETHR_HAVE_GCC_ASM_ARM_IC_IVAU_INSTRUCTION 1
...
#define FLOAT16_IS_CONVERTIBLE 1
...
/* define if compiler support _Pragma('GCC diagnostic ignored
   '-Wformat-nonliteral'') */
#define HAVE_GCC_DIAG_IGNORE_WFORMAT_NONLITERAL 1
