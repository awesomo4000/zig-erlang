...
#if (defined(__WIN32__) || defined(_WIN32) || defined(_WIN32_))
/* Windows cross-compilation: For static builds, WinDynNifCallbacks is defined
 * once in the runtime and declared extern at line 349. NIFs should not create
 * their own copy via ERL_NIF_INIT_GLOB. */
#  if defined(STATIC_ERLANG_NIF)
