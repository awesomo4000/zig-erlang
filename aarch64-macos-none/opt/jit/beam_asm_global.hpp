 ...
 *  Auto-generated by otp_src_28.1/erts/emulator/beam/jit/arm/beam_asm_global.hpp.pl.
 */
...
class BeamGlobalAssembler : public BeamAssembler {
    ...
    void emit_bif_bit_size_body(void);
    void emit_bif_byte_size_body(void);
    void emit_bif_element_body_shared(void);
    void emit_bif_element_guard_shared(void);
    void emit_bif_is_eq_exact_shared(void);
    void emit_bif_is_ne_exact_shared(void);
    void emit_bif_tuple_size_body(void);
    void emit_bif_tuple_size_guard(void);
    ...
    void emit_handle_and_error(void);
    void emit_handle_call_fun_error(void);
    void emit_handle_element_error_shared(void);
    ...
    void emit_handle_not_error(void);
    void emit_handle_or_error(void);
    void emit_handle_tl_error(void);
    ...
    void emit_i_line_breakpoint_trampoline_shared(void);
    void emit_i_loop_rec_shared(void);
    void emit_i_test_yield_shared(void);
    void emit_i_bxor_body_shared(void);
    void emit_int128_to_big_shared(void);
    void emit_int_div_rem_body_shared(void);
    void emit_int_div_rem_guard_shared(void);
    void emit_is_eq_exact_list_shared(void);
    void emit_is_eq_exact_shallow_boxed_shared(void);
    void emit_is_in_range_shared(void);
    void emit_is_ge_lt_shared(void);
    void emit_minus_body_shared(void);
    void emit_mul_add_body_shared(void);
    void emit_mul_add_guard_shared(void);
    void emit_mul_body_shared(void);
    void emit_mul_guard_shared(void);
    ...
    void emit_raise_exception_null_exp(void);
    void emit_raise_exception_shared(void);
    void emit_raise_shared(void);
    ...
    void emit_update_map_single_assoc_shared(void);
    void emit_update_map_exact_guard_shared(void);
    void emit_update_map_exact_body_shared(void);
    void emit_update_map_single_exact_body_shared(void);
...
public:
    ...
    void (*get_bif_bit_size_body(void))() { return get(bif_bit_size_body); }
    void (*get_bif_byte_size_body(void))() { return get(bif_byte_size_body); }
    void (*get_bif_element_body_shared(void))() { return get(bif_element_body_shared); }
    void (*get_bif_element_guard_shared(void))() { return get(bif_element_guard_shared); }
    void (*get_bif_is_eq_exact_shared(void))() { return get(bif_is_eq_exact_shared); }
    void (*get_bif_is_ne_exact_shared(void))() { return get(bif_is_ne_exact_shared); }
    void (*get_bif_tuple_size_body(void))() { return get(bif_tuple_size_body); }
    void (*get_bif_tuple_size_guard(void))() { return get(bif_tuple_size_guard); }
    ...
    void (*get_handle_and_error(void))() { return get(handle_and_error); }
    void (*get_handle_call_fun_error(void))() { return get(handle_call_fun_error); }
    void (*get_handle_element_error_shared(void))() { return get(handle_element_error_shared); }
    ...
    void (*get_handle_not_error(void))() { return get(handle_not_error); }
    void (*get_handle_or_error(void))() { return get(handle_or_error); }
    void (*get_handle_tl_error(void))() { return get(handle_tl_error); }
    ...
    void (*get_i_line_breakpoint_trampoline_shared(void))() { return get(i_line_breakpoint_trampoline_shared); }
    ...
    void (*get_int128_to_big_shared(void))() { return get(int128_to_big_shared); }
    ...
    void (*get_is_eq_exact_list_shared(void))() { return get(is_eq_exact_list_shared); }
    void (*get_is_eq_exact_shallow_boxed_shared(void))() { return get(is_eq_exact_shallow_boxed_shared); }
    ...
    void (*get_mul_add_body_shared(void))() { return get(mul_add_body_shared); }
    void (*get_mul_add_guard_shared(void))() { return get(mul_add_guard_shared); }
    void (*get_mul_body_shared(void))() { return get(mul_body_shared); }
    void (*get_mul_guard_shared(void))() { return get(mul_guard_shared); }
    ...
    void (*get_raise_exception_null_exp(void))() { return get(raise_exception_null_exp); }
    void (*get_raise_exception_shared(void))() { return get(raise_exception_shared); }
    void (*get_raise_shared(void))() { return get(raise_shared); }
    ...
    void (*get_update_map_single_assoc_shared(void))() { return get(update_map_single_assoc_shared); }
    ...
    void (*get_update_map_single_exact_body_shared(void))() { return get(update_map_single_exact_body_shared); }
    ...
    void (*get_i_line_breakpoint_cleanup(void))() { return get(i_line_breakpoint_cleanup); }
...
BeamGlobalAssembler::emitPtrs = {
    ...
    {bif_bit_size_body, &BeamGlobalAssembler::emit_bif_bit_size_body},
    {bif_byte_size_body, &BeamGlobalAssembler::emit_bif_byte_size_body},
    {bif_element_body_shared, &BeamGlobalAssembler::emit_bif_element_body_shared},
    {bif_element_guard_shared, &BeamGlobalAssembler::emit_bif_element_guard_shared},
    {bif_is_eq_exact_shared, &BeamGlobalAssembler::emit_bif_is_eq_exact_shared},
    {bif_is_ne_exact_shared, &BeamGlobalAssembler::emit_bif_is_ne_exact_shared},
    {bif_tuple_size_body, &BeamGlobalAssembler::emit_bif_tuple_size_body},
    {bif_tuple_size_guard, &BeamGlobalAssembler::emit_bif_tuple_size_guard},
    ...
    {handle_and_error, &BeamGlobalAssembler::emit_handle_and_error},
    {handle_call_fun_error, &BeamGlobalAssembler::emit_handle_call_fun_error},
    {handle_element_error_shared, &BeamGlobalAssembler::emit_handle_element_error_shared},
    ...
    {handle_not_error, &BeamGlobalAssembler::emit_handle_not_error},
    {handle_or_error, &BeamGlobalAssembler::emit_handle_or_error},
    {handle_tl_error, &BeamGlobalAssembler::emit_handle_tl_error},
    ...
    {i_line_breakpoint_trampoline_shared, &BeamGlobalAssembler::emit_i_line_breakpoint_trampoline_shared},
    ...
    {int128_to_big_shared, &BeamGlobalAssembler::emit_int128_to_big_shared},
    ...
    {is_eq_exact_list_shared, &BeamGlobalAssembler::emit_is_eq_exact_list_shared},
    {is_eq_exact_shallow_boxed_shared, &BeamGlobalAssembler::emit_is_eq_exact_shallow_boxed_shared},
    ...
    {mul_add_body_shared, &BeamGlobalAssembler::emit_mul_add_body_shared},
    {mul_add_guard_shared, &BeamGlobalAssembler::emit_mul_add_guard_shared},
    {mul_body_shared, &BeamGlobalAssembler::emit_mul_body_shared},
    {mul_guard_shared, &BeamGlobalAssembler::emit_mul_guard_shared},
    ...
    {raise_exception_null_exp, &BeamGlobalAssembler::emit_raise_exception_null_exp},
    {raise_exception_shared, &BeamGlobalAssembler::emit_raise_exception_shared},
    {raise_shared, &BeamGlobalAssembler::emit_raise_shared},
    ...
    {update_map_single_assoc_shared, &BeamGlobalAssembler::emit_update_map_single_assoc_shared},
    ...
    {update_map_single_exact_body_shared, &BeamGlobalAssembler::emit_update_map_single_exact_body_shared},
...
BeamGlobalAssembler::labelNames = {
    ...
    {bif_bit_size_body, "bif_bit_size_body"},
    {bif_byte_size_body, "bif_byte_size_body"},
    {bif_element_body_shared, "bif_element_body_shared"},
    {bif_element_guard_shared, "bif_element_guard_shared"},
    {bif_is_eq_exact_shared, "bif_is_eq_exact_shared"},
    {bif_is_ne_exact_shared, "bif_is_ne_exact_shared"},
    {bif_tuple_size_body, "bif_tuple_size_body"},
    {bif_tuple_size_guard, "bif_tuple_size_guard"},
    ...
    {handle_and_error, "handle_and_error"},
    {handle_call_fun_error, "handle_call_fun_error"},
    {handle_element_error_shared, "handle_element_error_shared"},
    ...
    {handle_not_error, "handle_not_error"},
    {handle_or_error, "handle_or_error"},
    {handle_tl_error, "handle_tl_error"},
