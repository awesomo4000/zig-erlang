...
#define ERTS_ALC_N_MAX_A_SHORT_LIVED (94)

/* Type numbers used for std_alloc */
#define ERTS_ALC_N_MIN_A_STANDARD (95)
#define ERTS_ALC_N_MAX_A_STANDARD (143)

/* Type numbers used for ll_alloc */
#define ERTS_ALC_N_MIN_A_LONG_LIVED (144)
#define ERTS_ALC_N_MAX_A_LONG_LIVED (189)

/* Type numbers used for eheap_alloc */
#define ERTS_ALC_N_MIN_A_EHEAP (190)
#define ERTS_ALC_N_MAX_A_EHEAP (194)

/* Type numbers used for ets_alloc */
#define ERTS_ALC_N_MIN_A_ETS (195)
#define ERTS_ALC_N_MAX_A_ETS (203)

/* Type numbers used for fix_alloc */
#define ERTS_ALC_N_MIN_A_FIXED_SIZE (204)
#define ERTS_ALC_N_MAX_A_FIXED_SIZE (218)

/* Type numbers used for literal_alloc */
#define ERTS_ALC_N_MIN_A_LITERAL (219)
#define ERTS_ALC_N_MAX_A_LITERAL (219)

/* Type numbers used for binary_alloc */
#define ERTS_ALC_N_MIN_A_BINARY (220)
#define ERTS_ALC_N_MAX_A_BINARY (221)

/* Type numbers used for driver_alloc */
#define ERTS_ALC_N_MIN_A_DRIVER (222)
#define ERTS_ALC_N_MAX_A_DRIVER (236)

/* Type numbers used for test_alloc */
#define ERTS_ALC_N_MIN_A_TEST (237)
#define ERTS_ALC_N_MAX_A_TEST (237)

#define ERTS_ALC_N_MAX (237)
...
#define ERTS_ALC_T_RE_SHORTLIVED (5347)
...
#define ERTS_ALC_T_TRACE_INFO_REQ (9043)
#define ERTS_ALC_T_SETUP_CONN_ARG (9171)
#define ERTS_ALC_T_LIST_TRAP (9299)
#define ERTS_ALC_T_CONT_EXIT_TRAP (9427)
#define ERTS_ALC_T_SEQ_YIELD_STATE (9571)
#define ERTS_ALC_T_PHASH2_TRAP (9683)
#define ERTS_ALC_T_MAP_TRAP (9811)
#define ERTS_ALC_T_PERSISTENT_LOCK_Q (9955)
#define ERTS_ALC_T_PERSISTENT_TERM_TMP (10083)
#define ERTS_ALC_T_T2B_VEC (10195)
#define ERTS_ALC_T_ETHR_SL (10339)
#define ERTS_ALC_T_SYS_MSG_Q (10451)
#define ERTS_ALC_T_SL_MPATHS (10595)
#define ERTS_ALC_T_T2B_DETERMINISTIC (10707)
#define ERTS_ALC_T_DSIG_HNDL_NTFY (10835)
#define ERTS_ALC_T_SCHD_SIG_NTFY (10963)
#define ERTS_ALC_T_DEBUG (11107)
#define ERTS_ALC_T_LITERAL_REF (11187)
#define ERTS_ALC_T_PURGE_DATA (11315)
#define ERTS_ALC_T_AINFO_REQ (11491)
#define ERTS_ALC_T_SCHED_WTIME_REQ (11619)
#define ERTS_ALC_T_GC_INFO_REQ (11747)
#define ERTS_ALC_T_SYS_CHECK_REQ (11875)
#define ERTS_ALC_T_SHORT_LIVED_TERM (12003)
#define ERTS_ALC_T_POLLSET_UPDREQ (12131)
#define ERTS_ALC_T_REG_PROC (12244)
#define ERTS_ALC_T_PAUSED_TIMER (12372)
#define ERTS_ALC_T_REG_TABLE (12516)
#define ERTS_ALC_T_FUN_TABLE (12596)
#define ERTS_ALC_T_DIST_TABLE (12772)
#define ERTS_ALC_T_NODE_TABLE (12900)
#define ERTS_ALC_T_MODULE_REFS (12980)
#define ERTS_ALC_T_NC_STD (13156)
#define ERTS_ALC_T_DCACHE (13284)
#define ERTS_ALC_T_DIST_ENTRY (13412)
#define ERTS_ALC_T_NODE_ENTRY (13540)
#define ERTS_ALC_T_ARG_REG (13652)
#define ERTS_ALC_T_PROC_DICT (13780)
#define ERTS_ALC_T_CALLS_BUF (13908)
#define ERTS_ALC_T_BPD (14052)
#define ERTS_ALC_T_LINEBUF (14180)
#define ERTS_ALC_T_IOQ (14308)
#define ERTS_ALC_T_BITS_BUF (14436)
#define ERTS_ALC_T_DB_NTAB_ENT (14532)
#define ERTS_ALC_T_DDLL_HANDLE (14692)
#define ERTS_ALC_T_RE_PRECOMPILE (14820)
#define ERTS_ALC_T_PSD (14932)
#define ERTS_ALC_T_PRTSD (15076)
#define ERTS_ALC_T_MREF_ENT (15204)
#define ERTS_ALC_T_MREF_TAB_BKTS (15332)
#define ERTS_ALC_T_PREF_ENT (15460)
#define ERTS_ALC_T_PREF_TAB_BKTS (15588)
#define ERTS_ALC_T_CRASH_DUMP (15716)
#define ERTS_ALC_T_THR_Q_EL (15844)
#define ERTS_ALC_T_THR_Q (15972)
#define ERTS_ALC_T_ZLIB (16100)
#define ERTS_ALC_T_DRIVER_LOCK (16228)
#define ERTS_ALC_T_ML_DIST (16356)
#define ERTS_ALC_T_ETHR_STD (16484)
#define ERTS_ALC_T_CODE_COVERAGE (16612)
#define ERTS_ALC_T_PRIO_Q_INFO (16724)
#define ERTS_ALC_T_DDLL_PROCESS (16868)
#define ERTS_ALC_T_MONITOR_EXT (16980)
#define ERTS_ALC_T_LINK_EXT (17108)
#define ERTS_ALC_T_DB_HEIR_DATA (17220)
#define ERTS_ALC_T_NFUNC_TRAP_WRAPPER (17364)
#define ERTS_ALC_T_MONITOR_TAG (17492)
#define ERTS_ALC_T_ALIAS (17620)
#define ERTS_ALC_T_MONITOR_SUSPEND (17748)
#define ERTS_ALC_T_PORT_DATA_HEAP (17892)
#define ERTS_ALC_T_ATOMICS (18020)
#define ERTS_ALC_T_COUNTERS (18148)
#define ERTS_ALC_T_FD_ENTRY_BUF (18276)
#define ERTS_ALC_T_SYS_BLOCKING (18404)
#define ERTS_ALC_T_ATOM (18453)
#define ERTS_ALC_T_MODULE (18613)
#define ERTS_ALC_T_FUN_ENTRY (18741)
#define ERTS_ALC_T_ATOM_TXT (18837)
#define ERTS_ALC_T_TIMER_SERVICE (19045)
#define ERTS_ALC_T_ATOM_TABLE (19093)
#define ERTS_ALC_T_MODULE_TABLE (19253)
#define ERTS_ALC_T_TAINT (19381)
#define ERTS_ALC_T_PROC_TABLE (19541)
#define ERTS_ALC_T_PORT_TABLE (19685)
#define ERTS_ALC_T_TIMER_WHEEL (19813)
#define ERTS_ALC_T_ASYNC_DATA (19941)
#define ERTS_ALC_T_DB_TABLES (20037)
#define ERTS_ALC_T_SCHDLR_SLP_INFO (20197)
#define ERTS_ALC_T_RUNQS (20325)
#define ERTS_ALC_T_DDLL_ERRCODES (20453)
#define ERTS_ALC_T_RE_INIT (20581)
#define ERTS_ALC_T_PRE_ALLOC_DATA (20709)
#define ERTS_ALC_T_CPUDATA (20837)
#define ERTS_ALC_T_CPU_GRPS_MAP (20965)
#define ERTS_ALC_T_MISC_AUX_WORK_Q (21093)
#define ERTS_ALC_T_TRACER_NIF (21221)
#define ERTS_ALC_T_MREF_TAB (21349)
#define ERTS_ALC_T_PREF_TAB (21477)
#define ERTS_ALC_T_RLA_BLOCK_CNTRS (21605)
#define ERTS_ALC_T_THR_Q_LL (21733)
#define ERTS_ALC_T_RUNQ_BLNS (21861)
#define ERTS_ALC_T_THR_PRGR_IDATA (21989)
#define ERTS_ALC_T_THR_PRGR_DATA (22117)
#define ERTS_ALC_T_PERSISTENT_TERM (22197)
#define ERTS_ALC_T_ETHR_LL (22373)
#define ERTS_ALC_T_FP_EXCEPTION (22501)
#define ERTS_ALC_T_LL_MPATHS (22629)
#define ERTS_ALC_T_EXPORT_TABLE (22709)
#define ERTS_ALC_T_EXPORT (22837)
#define ERTS_ALC_T_CATCHES (22965)
#define ERTS_ALC_T_DB_MS_PSDO_PROC (23109)
#define ERTS_ALC_T_SCHDLR_DATA (23269)
#define ERTS_ALC_T_DRV_TAB (23397)
#define ERTS_ALC_T_DRV_EV_STATE (23525)
#define ERTS_ALC_T_POLLSET (23653)
#define ERTS_ALC_T_POLL_FDS (23781)
#define ERTS_ALC_T_BLOCK_PTHR_DATA (23909)
#define ERTS_ALC_T_FD_STATUS (24037)
#define ERTS_ALC_T_SELECT_FDS (24165)
#define ERTS_ALC_T_CS_PROG_PATH (24293)
#define ERTS_ALC_T_BEAM_REGISTER (24406)
#define ERTS_ALC_T_HEAP (24534)
#define ERTS_ALC_T_OLD_HEAP (24662)
#define ERTS_ALC_T_HEAP_FRAG (24790)
#define ERTS_ALC_T_MSG (24918)
#define ERTS_ALC_T_DB_TABLE (25031)
#define ERTS_ALC_T_DB_SEG (25159)
#define ERTS_ALC_T_DB_STK (25287)
#define ERTS_ALC_T_DB_TRANS_TAB (25415)
#define ERTS_ALC_T_DB_SEL_LIST (25543)
#define ERTS_ALC_T_DB_DMC_ERROR (25671)
#define ERTS_ALC_T_DB_DMC_ERR_INFO (25799)
#define ERTS_ALC_T_DB_TERM (25927)
#define ERTS_ALC_T_ETS_CTRS (26055)
#define ERTS_ALC_T_PROC (26200)
#define ERTS_ALC_T_RECV_MARK_BLK (26328)
#define ERTS_ALC_T_MSG_REF (26456)
#define ERTS_ALC_T_LL_PTIMER (26584)
#define ERTS_ALC_T_HL_PTIMER (26712)
#define ERTS_ALC_T_BIF_TIMER (26840)
#define ERTS_ALC_T_MREF_NSCHED_ENT (26984)
#define ERTS_ALC_T_PREF_NSCHED_ENT (27112)
#define ERTS_ALC_T_MINDIRECTION (27240)
#define ERTS_ALC_T_SIGQ_BUFFERS (27352)
#define ERTS_ALC_T_THR_Q_EL_SL (27496)
#define ERTS_ALC_T_MONITOR (27608)
#define ERTS_ALC_T_LINK (27736)
#define ERTS_ALC_T_DRV_SEL_D_STATE (27880)
#define ERTS_ALC_T_NIF_SEL_D_STATE (28008)
#define ERTS_ALC_T_LITERAL (28089)
#define ERTS_ALC_T_DRV_BINARY (28202)
#define ERTS_ALC_T_BINARY (28330)
#define ERTS_ALC_T_PORT (28523)
#define ERTS_ALC_T_DRV (28651)
#define ERTS_ALC_T_DRIVER (28779)
#define ERTS_ALC_T_DRV_CMD_DATA (28907)
#define ERTS_ALC_T_DRV_CTRL_DATA (29035)
#define ERTS_ALC_T_DRV_CALL_DATA (29163)
#define ERTS_ALC_T_NIF (29291)
#define ERTS_ALC_T_PORT_DATA_LOCK (29419)
#define ERTS_ALC_T_DRV_THR_OPTS (29547)
#define ERTS_ALC_T_DRV_TID (29675)
#define ERTS_ALC_T_DRV_MTX (29803)
#define ERTS_ALC_T_DRV_CND (29931)
#define ERTS_ALC_T_DRV_RWLCK (30059)
#define ERTS_ALC_T_DRV_TSD (30187)
#define ERTS_ALC_T_MSACC (30315)
#define ERTS_ALC_T_TEST (30444)
...
const ErtsAlcType_t erts_alc_n2t[] = {
  ...
  ERTS_ALC_T_ML_DIST,
  ERTS_ALC_T_ETHR_STD,
  ERTS_ALC_T_CODE_COVERAGE,
  ERTS_ALC_T_PRIO_Q_INFO,
