...
case op_bif_and_jssd: {
  emit_bif_and(args[0], args[1], args[2], args[3]);
  break;
}

case op_bif_bit_size_jsd: {
  emit_bif_bit_size(args[0], args[1], args[2]);
  break;
}

case op_bif_byte_size_jsd: {
  emit_bif_byte_size(args[0], args[1], args[2]);
  break;
}
...
case op_bif_not_jSd: {
  emit_bif_not(args[0], args[1], args[2]);
  break;
}

case op_bif_or_jssd: {
  emit_bif_or(args[0], args[1], args[2], args[3]);
  break;
}

case op_bif_tl_sd: {
  emit_bif_tl(args[0], args[1]);
  break;
}

case op_bif_tuple_size_jSd: {
  emit_bif_tuple_size(args[0], args[1], args[2]);
  break;
}
...
case op_executable_line_II: {
  emit_executable_line(args[0], args[1]);
  break;
}
...
case op_i_band_jIssd: {
  emit_i_band(args[0], args[1], args[2], args[3], args[4]);
  break;
}
...
case op_i_bnot_jIsd: {
  emit_i_bnot(args[0], args[1], args[2], args[3]);
  break;
}

case op_i_bor_jIssd: {
  emit_i_bor(args[0], args[1], args[2], args[3], args[4]);
  break;
}
...
case op_i_bs_get_bin_and_tail_SftStdd: {
  emit_i_bs_get_bin_and_tail(args[0], args[1], args[2], args[3], args[4], args[5], args[6]);
  break;
}
...
case op_i_bsl_jIssd: {
  emit_i_bsl(args[0], args[1], args[2], args[3], args[4]);
  break;
}

case op_i_bsr_jIssd: {
  emit_i_bsr(args[0], args[1], args[2], args[3], args[4]);
  break;
}

case op_i_bxor_jIssd: {
  emit_i_bxor(args[0], args[1], args[2], args[3], args[4]);
  break;
}
...
case op_i_debug_line_IIt: {
  emit_i_debug_line(args[0], args[1], args[2]);
  break;
}

case op_i_div_rem_jIssdd: {
  emit_i_div_rem(args[0], args[1], args[2], args[3], args[4], args[5]);
  break;
}
...
case op_i_func_label_L: {
  emit_i_func_label(args[0]);
  break;
}
...
case op_i_int_div_jIssd: {
  emit_i_int_div(args[0], args[1], args[2], args[3], args[4]);
  break;
}
...
case op_i_is_tuple_of_arity_ff_ffsA: {
  emit_i_is_tuple_of_arity_ff(args[0], args[1], args[2], args[3]);
  break;
}
...
case op_i_line_breakpoint_trampoline: {
  emit_i_line_breakpoint_trampoline();
  break;
}
...
case op_i_m_div_jIssd: {
  emit_i_m_div(args[0], args[1], args[2], args[3], args[4]);
  break;
}
...
case op_i_minus_jIssd: {
  emit_i_minus(args[0], args[1], args[2], args[3], args[4]);
  break;
}
...
case op_i_mul_add_jssssd: {
  emit_i_mul_add(args[0], args[1], args[2], args[3], args[4], args[5]);
  break;
}
...
case op_i_plus_jIssd: {
  emit_i_plus(args[0], args[1], args[2], args[3], args[4]);
  break;
}

case op_i_rem_div_jIssdd: {
  emit_i_rem_div(args[0], args[1], args[2], args[3], args[4], args[5]);
  break;
}

case op_i_rem_jIssd: {
  emit_i_rem(args[0], args[1], args[2], args[3], args[4]);
  break;
}
...
case op_i_unary_minus_jIsd: {
  emit_i_unary_minus(args[0], args[1], args[2], args[3]);
  break;
}
...
case op_load_two_xregs_dxdx: {
  emit_load_two_xregs(args[0], args[1], args[2], args[3]);
  break;
}
...
case op_mark_unreachable: {
  emit_mark_unreachable();
  break;
}

case op_move_call_ext_last_ydet: {
  emit_move_call_ext_last(args[0], args[1], args[2], args[3]);
  break;
}

case op_move_call_last_ydft: {
  emit_move_call_last(args[0], args[1], args[2], args[3]);
  break;
}

case op_move_deallocate_return: {
  emit_move_deallocate_return();
  break;
}

case op_move_trim_sdt: {
  emit_move_trim(args[0], args[1], args[2]);
  break;
}

case op_move_two_trim_ydydt: {
  emit_move_two_trim(args[0], args[1], args[2], args[3], args[4]);
  break;
}
...
case op_put_list2_sssd: {
  emit_put_list2(args[0], args[1], args[2], args[3]);
  break;
}

case op_put_list_deallocate_ssdt: {
  emit_put_list_deallocate(args[0], args[1], args[2], args[3]);
  break;
}

case op_put_list_ssd: {
  emit_put_list(args[0], args[1], args[2]);
  break;
}
...
case op_store_two_values_sdsd: {
  emit_store_two_values(args[0], args[1], args[2], args[3]);
  break;
}

case op_swap2_ddd: {
  emit_swap2(args[0], args[1], args[2]);
  break;
}

case op_swap3_dddd: {
  emit_swap3(args[0], args[1], args[2], args[3]);
  break;
}

case op_swap4_ddddd: {
  emit_swap4(args[0], args[1], args[2], args[3], args[4]);
  break;
}
...
case op_try_end_deallocate_t: {
  emit_try_end_deallocate(args[0]);
  break;
}

case op_try_end_move_deallocate_sdt: {
  emit_try_end_move_deallocate(args[0], args[1], args[2]);
  break;
}
...
case op_update_record_in_place_IsdI: {
  emit_update_record_in_place(args[0], args[1], args[2], args[3], args.subspan(4,args.size() - 4));
  break;
}
